  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          <div className="flex items-center gap-3">
            <div className="bg-eduGreen-100 p-2 rounded-lg">
              <BookOpen className="text-eduGreen-600" size={20} />
            </div>
            <div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          <div className="flex items-center gap-3">
            <div className="bg-eduGreen-100 p-2 rounded-lg">
              <Award className="text-eduGreen-600" size={20} />
            </div>
            <div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <h2 className="text-lg font-semibold mb-4">Continue Aprendendo</h2>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="space-y-3">
            {userData.recommendedTracks.map(track => (
              <div 
                key={track.id} 
                className="border rounded-lg p-4 hover:border-eduGreen-400 transition-colors cursor-pointer"
              >
                <div className="flex items-start gap-3">
                  <div className="bg-eduGreen-100 p-2 rounded-lg mt-1">
                    <BookOpen className="text-eduGreen-600" size={18} />
                  </div>
                  <div>
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center gap-2 mb-2">
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div className="bg-eduGreen-500 h-2.5 rounded-full w-2/5"></div>
              </div>
            ...
            <div className="flex items-center justify-between text-sm mt-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-eduBlue-600">{userData.currentStreak}</p>
                <p className="text-xs text-gray-500">Dias seguidos</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-eduGreen-600">{userData.level}</p>
                <p className="text-xs text-gray-500">Seu nível</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-eduBlue-600">{userData.badges.filter(b => b.completed).length}</p>
